            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Center(child: Text("Answer",style: TextStyle(fontSize: 40))),
                  Divider(thickness: 8,color: CupertinoColors.activeGreen),

                  Center(
                    child: Container(
                      child: Text("None", style: TextStyle(fontSize: 18),textAlign: TextAlign.center),
                    ),
                  ),
